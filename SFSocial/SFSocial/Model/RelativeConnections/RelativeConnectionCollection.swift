//
//  RelativeConnectionCollection.swift
//  SFSocial
//
...
public class RelativeConnectionCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: RelativeConnection = RelativeConnection(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: RelativeConnection = self.getNewItem() as! RelativeConnection
