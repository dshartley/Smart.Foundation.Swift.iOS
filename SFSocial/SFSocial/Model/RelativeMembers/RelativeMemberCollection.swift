//
//  RelativeMemberCollection.swift
//  SFSocial
//
...
public class RelativeMemberCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: RelativeMember = RelativeMember(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: RelativeMember = self.getNewItem() as! RelativeMember
