//
//  RelativeTimelineEventCollection.swift
//  SFSocial
//
...
public class RelativeTimelineEventCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: RelativeTimelineEvent = RelativeTimelineEvent(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: RelativeTimelineEvent = self.getNewItem() as! RelativeTimelineEvent
