...
/// Encapsulates a collection of PlaySpaceType items
public class PlaySpaceTypeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlaySpaceType = PlaySpaceType(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlaySpaceType = self.getNewItem() as! PlaySpaceType
