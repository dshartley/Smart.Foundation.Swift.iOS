//
//  PlaySpaceBitTypeCollection.swift
//  SFGame
//
...
/// Encapsulates a collection of PlaySpaceBitType items
public class PlaySpaceBitTypeCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlaySpaceBitType = PlaySpaceBitType(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlaySpaceBitType = self.getNewItem() as! PlaySpaceBitType
