...
/// Encapsulates a collection of PlaySpaceBit items
public class PlaySpaceBitCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlaySpaceBit = PlaySpaceBit(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlaySpaceBit = self.getNewItem() as! PlaySpaceBit
