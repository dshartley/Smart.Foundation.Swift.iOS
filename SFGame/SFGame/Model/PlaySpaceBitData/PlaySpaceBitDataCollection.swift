//
//  PlaySpaceBitDataCollection.swift
//  SFGame
//
...
/// Encapsulates a collection of PlaySpaceBitData items
public class PlaySpaceBitDataCollection: ModelItemCollectionBase {
	...
	public override func getNewItem() -> ProtocolModelItem? {
		...
		// Create the new item
		let item: PlaySpaceBitData = PlaySpaceBitData(collection: self,
	...
	public override func getNewItem(dataNode:[String: Any],
		...
		// Create the item
		let item: PlaySpaceBitData = self.getNewItem() as! PlaySpaceBitData
